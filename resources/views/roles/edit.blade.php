...
@section('title', 'Editar Rol - Brunett')
    ...
    <div class="panel">
        <form action="{{ route('roles.update', $role) }}" method="POST">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="name" value="{{ $role->name }}" required class="form-control" style="width: 100%;">
            </div>
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" style="width: 18px; height: 18px;" {{ in_array($permission->name, $rolePermissions) ? 'checked' : '' }}>
